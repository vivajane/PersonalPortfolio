  ...
  return (
    <div id="experience" className="md:px-24 sm:px-12 px-8 py-10">
      <h1
        ...
        className="font-playfair sm:text-xl text-sm md:text-3xl py-6 font-bold text-center"
      >
        EXPERIENCES
      </h1>
      <ul className="space-y-10 ">
        {experiences.map((experience) => (
          <li
            className="border-2 rounded-lg shadow-2xl py-16 px-8"
            key={experience.id}
          >
  ...
  return (
    <div>
      ...
      <p className="flex  justify-between">
        <span className="font-semibold text-[10px] sm:text-sm md:text-base ">
          {experience.company}
        </span>
        <span className="font-semibold text-[10px] sm:text-sm md:text-base ">
          {experience.date}
      ...
      <p className="py-4 text-[#828282] text-xs sm:text-sm md:text-base font-bold leading-[30px]">
